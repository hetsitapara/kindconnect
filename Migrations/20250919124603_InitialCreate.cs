        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Mission = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NGOProfiles_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Events_NGOProfiles_NGOId",
                        column: x => x.NGOId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Certificates_AspNetUsers_GeneratedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VolunteerApplications_AspNetUsers_RespondedByUserId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", null, "Superuser", "SUPERUSER" },
                    { "2", null, "NGO", "NGO" },
                    { "3", null, "Volunteer", "VOLUNTEER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VolunteerApplications_EventId_UserId",
                table: "VolunteerApplications",
                columns: new[] { "EventId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VolunteerApplications_RespondedByUserId",
                table: "VolunteerApplications",
